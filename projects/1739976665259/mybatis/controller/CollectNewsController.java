...
public class CollectNewsController {
    ...
    **/
    ...
    public Object insert(CollectNews collectNews){
        return collectNewsService.insert(collectNews);
    }
    ...
    **/
    ...
    public Object delete(int id){
        return collectNewsService.delete(id);
    }
    ...
    **/
    ...
    public Object update(CollectNews collectNews){
        return collectNewsService.update(collectNews);
    }
    ...
    **/
    ...
    public Object load(int id){
        return collectNewsService.load(id);
    }
    ...
    **/
    ...
    public Map<String, Object> pageList(@RequestParam(required = false, defaultValue = "0") int offset,
        ...
        return collectNewsService.pageList(offset, pagesize);
    }
